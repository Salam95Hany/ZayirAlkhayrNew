...
{
    public class AcademicStageSpecification: BaseSpecification<AcademicStage>
    {
        public AcademicStageSpecification(PagingFilterModel filterModel, bool applyPaging = true) : base()
        {
