...
{
    public class DiscountTypeSpecification: BaseSpecification<DiscountType>
    {
        public DiscountTypeSpecification(PagingFilterModel filterModel, bool applyPaging = true) : base()
        {
