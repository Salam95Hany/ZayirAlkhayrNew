...
{
    public class FamilyNeedCategoryFilterSpecification : BaseSpecification<FamilyNeedCategory>
    {
        public FamilyNeedCategoryFilterSpecification(PagingFilterModel filterModel, bool applyPaging = true) : base()
        {
