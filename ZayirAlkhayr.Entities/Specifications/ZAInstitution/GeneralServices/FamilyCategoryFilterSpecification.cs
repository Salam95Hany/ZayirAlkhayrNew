...
{
    public class FamilyCategoryFilterSpecification : BaseSpecification<FamilyCategory>
    {
        public FamilyCategoryFilterSpecification(PagingFilterModel filterModel, bool applyPaging = true) : base()
        {
