...
{
    public class ActivityDataSpecification:BaseSpecification<Activity>
    {
        public ActivityDataSpecification(PagingFilterModel PagingFilter, bool applyPaging = true)
        {
