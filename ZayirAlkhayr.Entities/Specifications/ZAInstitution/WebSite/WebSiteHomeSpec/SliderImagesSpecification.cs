...
{
    public class SliderImagesSpecification:BaseSpecification<SliderImage>
    {
        public SliderImagesSpecification(PagingFilterModel PagingFilter, bool applyPaging = true)
        {
