...
{
    public class BeneFactorNationalitySpecification:BaseSpecification<BeneFactorNationality>
    {
        public BeneFactorNationalitySpecification(PagingFilterModel PagingFilter, bool applyPaging = true)
        {
